    ...
    public BookStatisticsData getBookStatisticsData() {
        ...
        try {
            ...
            if (totalBooks != existingBooks + notExistingBooks) {
                throw new RuntimeException("Liczba wszystkich ksi��ek (" + totalBooks + ") nie jest r�wna sumie liczby posiadanych ksi��ek (" + existingBooks + ") i liczby wycofanych ksi��ek (" + notExistingBooks + ").");
            }
