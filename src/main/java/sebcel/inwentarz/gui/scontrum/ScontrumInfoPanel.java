...
public class ScontrumInfoPanel extends JPanel {
    ...
    public ScontrumInfoPanel() {
        ...
        progressPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Informacjee na temat bieżącego skontrum"));
        ...
        progressPanel.add(new JLabel("Data rozpoczęcia: ", JLabel.RIGHT), LayoutUtils.labelConstraints(0, 1));
        progressPanel.add(dataRozpoczecia, LayoutUtils.textConstraints(1, 1));

        progressPanel.add(new JLabel("Postęp: ", JLabel.RIGHT), LayoutUtils.labelConstraints(0, 2));
        ...
        progressPanel.add(new JLabel("Liczba zweryfikowanych książek: ", JLabel.RIGHT), LayoutUtils.labelConstraints(2, 0));
        progressPanel.add(liczbaZweryfikowanychKsiazek, LayoutUtils.textConstraints(3, 0));

        progressPanel.add(new JLabel("Liczba niezweryfikowanych książek: ", JLabel.RIGHT), LayoutUtils.labelConstraints(2, 1));
        progressPanel.add(liczbaNiezweryfikowanychKsiazek, LayoutUtils.textConstraints(3, 1));

        progressPanel.add(new JLabel("Całkowita liczba posiadanych książek: ", JLabel.RIGHT), LayoutUtils.labelConstraints(2, 2));
    ...
    private void set(ScontrumStatisticsData data) {
        status.setText("Skontrum jest rozpoczęte (id = " + Integer.toString(data.getId()) + ")");
    ...
    private void reset() {
        status.setText("Skontrum nie jest rozpoczęte");
