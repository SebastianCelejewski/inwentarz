...
public class ScontrumViewFrame extends JDialog implements IScontrumViewer {
    ...
    public ScontrumViewFrame(IScontrumDao scontrumDao) {
        ...
        addElement("Numer", id);
        addElement("Data rozpoczęcia", dataRozpoczecia);
        addElement("Data zakończenia", dataZakonczenia);
        addElement("Status", status);
        addElement("Liczba posiadanych książek", liczbaPosiadanychKsiazek);
        addElement("Liczba zweryfikowanych książek", liczbaZweryfikowanychKsiazek);
        addElement("Liczba niezweryfikowanych książek", liczbaNiezweryfikowanychKsiazek);
    ...
    public void viewScontrum(int scontrumId) {
        ...
        this.setTitle("Szczegóły skontrum");
        this.setModal(true);
        this.pack();
