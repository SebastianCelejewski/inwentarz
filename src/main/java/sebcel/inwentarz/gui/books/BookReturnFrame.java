...
public class BookReturnFrame extends JDialog implements IBookReturner {
    ...
    public void returnBook(int id) {
        int result = JOptionPane.showConfirmDialog(null, "Potwierdź operację zwrotu książki", "Zwrot książki", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
