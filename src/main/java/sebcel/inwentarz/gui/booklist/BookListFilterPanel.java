...
public class BookListFilterPanel extends JPanel implements IBookListFilter, DocumentListener, ActionListener {
    ...
    private FilterElement idFilterElement = new FilterElement("Nr inw.", "Numer inwentarzowy książki");
    private FilterElement titleFilterElement = new FilterElement("Tytuł", "Fragment tytułu książki");
    ...
    public BookListFilterPanel() {
        ...
        this.setBorder(BorderFactory.createTitledBorder("Filtr listy książek"));
