...
public class ScontrumListButtonPanel extends JPanel implements ISelectionListener<ScontrumStatus> {
    ...
    public ScontrumListButtonPanel(ILifecycleManager<ScontrumStatus> lifecycleManager) {
        ...
        viewDetailsButton = new ActionButton<ScontrumStatus>("Szczegóły", "Szczegóły skontrum", SelectionRequirement.SINGLE);
        startNewScontrumButton = new ActionButton<ScontrumStatus>("Rozpocznij", "Rozpoczęcie nowego skontrum", SelectionRequirement.ANY);
        finishCurrentScontrumButton = new LifecycleButton<ScontrumStatus>("Zakończ", "Zakończenie trwającego skontrum", ScontrumStatus.ZAKONCZONE, lifecycleManager);
