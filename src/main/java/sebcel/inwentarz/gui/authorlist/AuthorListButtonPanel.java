...
public class AuthorListButtonPanel extends JPanel {
    ...
    private JButton deleteBookButton = new JButton("Usuń");
    ...
    public AuthorListButtonPanel() {
        ...
        operationButtons.setBorder(BorderFactory.createTitledBorder("Zarządzanie"));
        ...
        deleteBookButton.setToolTipText("Usunięcie autora");
